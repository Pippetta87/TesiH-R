...
\begingroup
\let\clearpage\relax
\printbibliography[sorting=hot,title={\textcolor{Orchid}{Bibliografia modello solare e oltre}}]
\endgroup
...
\begingroup
\let\clearpage\relax
\printbibliography[sorting=hot,filter=staticdeviation,keyword={rev},title={\textcolor{violetw}{Biblio about ''Deviazioni da equlibrio idrostatico: campo magnetico, rotazione, trasporto momento angolare, turbolenza''}}]
\printbibliography[sorting=hot,filter=staticdeviation, notkeyword={rev},title={\textcolor{violetw}{Other refs about ''Deviazioni da equlibrio idrostatico: campo magnetico, rotazione, trasporto momento angolare, turbolenza''}}]
\endgroup
...
\begingroup
\let\clearpage\relax
\printbibliography[sorting=hot,filter=ssmunphys,keyword={rev},title={\textcolor{Veronica}{Biblio about: ''Incertezze nei parametri e nella fisica usata nel SSM''}}]
\printbibliography[sorting=hot,filter=ssmunphys,notkeyword={rev},title={\textcolor{Veronica}{Other refs about: ''Incertezze nei parametri e nella fisica usata nel SSM''}}]
\endgroup
...
\begin{refsection}[SModes.bib,VstarsRev.bib,waves.bib,HAseismRev.bib,HelioInversion.bib,innocenti.bib,cox.bib]
\nocite{*}
\begingroup
\let\clearpage\relax
\printbibliography
