...
\begingroup
\let\clearpage\relax
\printbibliography[filter=modesfreqobs,keyword={rev} and keyword={rotation},title={\textcolor{ochre}{Biblio about: ''Osservazione dei modi: strumenti e splitting dovuto alla rotazione.''}}]
\printbibliography[filter=modesfreqobs,notkeyword={rev} and keyword={rotation},title={\textcolor{ochre}{Other refs about: ''Osservazione dei modi: strumenti e splitting dovuto alla rotazione.''}}]
\endgroup
...
{\let\clearpage\relax
\chapter{Oscillazioni solari: Inversione rotazione.}}
\PartialToc
