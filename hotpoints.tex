...
\begingroup
\let\clearpage\relax
\printbibliography[filter=Staticdeviation,title={\textcolor{violetw}{Biblio about ''Deviazioni da equlibrio idrostatico: campo magnetico, rotazione, trasporto momento angolare, turbolenza''},sorting=hot]
\printbibliography[filter=staticdeviation,title={\textcolor{violetw}{Other refs about ''Deviazioni da equlibrio idrostatico: campo magnetico, rotazione, trasporto momento angolare, turbolenza''},sorting=hot]
\endgroup
...
\begingroup
\let\clearpage\relax
\printbibliography[filter=Ssmunphys,title={\textcolor{Veronica}{Biblio about: ''Incertezze nei parametri e nella fisica usata nel SSM''},sorting=hot]
\printbibliography[filter=ssmunphys,title={\textcolor{Veronica}{Other refs about: ''Incertezze nei parametri e nella fisica usata nel SSM''},sorting=hot]
\endgroup
