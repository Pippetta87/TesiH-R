...
\begin{refsection}[KinHydRev.bib,StellarModelS.bib,RotationMagneticS.bib,sunmeasure.bib]
...
\begin{refsection}[StellarModelS.bib,solarmodels.bib,KynHydRev.bib,VstarsRev.bib]
...
\printbibliography[filter=stellarplasma,keyword={rev},title={\textcolor{cadmiumorange}{Biblio about ''Fisica del (trasporto nel) plasma stellare''}}]

\printbibliography[filter=stellarplasma,notkeyword={rev},title={\textcolor{cadmiumorange}{Other refs about ''Fisica del (trasporto nel) plasma stellare''}}]
...
\begin{refsection}[SModes.bib,waves.bib,HAseismRev.bib]
