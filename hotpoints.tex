...
\begin{refsection}[RotationMagneticS.bib,SModes.bib,ObsModesTech.bib,waves.bib,VstarsRev.bib]

\begingroup
\nocite{*}
\let\clearpage\relax

\printbibliography[check=modesfreqobs,keyword={rev},heading=bibintoc,title={\textcolor{ochre}{Biblio about: ''Osservazione dei modi: strumenti e splitting dovuto alla rotazione.''}}]
\printbibliography[check=modesfreqobs,notkeyword={rev},heading=bibintoc,title={\textcolor{ochre}{Other refs about: ''Osservazione dei modi: strumenti e splitting dovuto alla rotazione.''}}]
